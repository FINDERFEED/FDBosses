...
public class BossEntities {
    ...
    public static final Supplier<EntityType<NetzachAerialGearAttack>> NETZACH_AERIAL_GEAR = ENTITIES.register("netzach_aerial_gear",()->EntityType.Builder.of(
                    NetzachAerialGearAttack::new, MobCategory.MISC
            )
            .sized(0.25f,0.25f)
    ...
    public static final Supplier<EntityType<NetzachGearCrushAttack>> NETZACH_GEAR_CRUSH = ENTITIES.register("netzach_gear_crush",()->EntityType.Builder.of(
                    NetzachGearCrushAttack::new, MobCategory.MISC
            )
            .sized(1.5F, 1.5F)
            .build("netzach_gear_crush"));


    public static final Supplier<EntityType<BacktrackEntity>> BACKTRACK_ENTITY = ENTITIES.register("backtrack_entity",()->EntityType.Builder.of(
                    BacktrackEntity::new, MobCategory.MISC
            )
            .sized(0.6F, 1.8F)
            .build("backtrack_entity"));


    public static final Supplier<EntityType<SectorAttack>> SECTOR_ATTACK = ENTITIES.register("sector_attack",()->EntityType.Builder.of(
                    SectorAttack::new, MobCategory.MISC
            )
            .sized(2F, 2F)
            .build("sector_attack"));
    ...
    public static final Supplier<EntityType<ClockAttack>> CLOCK_ATTACK = ENTITIES.register("clock_attack",()->EntityType.Builder.of(
                    ClockAttack::new, MobCategory.MISC
            )
            .sized(2F, 2F)
            .build("clock_attack"));
