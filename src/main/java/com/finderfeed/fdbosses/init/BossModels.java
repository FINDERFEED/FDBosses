...
public class BossModels {
    ...
    public static final Supplier<FDModelInfo> MALKUTH_SCREEN = INFOS.register("malkuth_screen",()->new FDModelInfo(ResourceLocation.tryBuild(FDBosses.MOD_ID,"malkuth_screen"),1f));
    ...
    public static final Supplier<FDModelInfo> MALKUTH_SPAWNER = INFOS.register("malkuth_boss_spawner",()->new FDModelInfo(ResourceLocation.tryBuild(FDBosses.MOD_ID,"malkuth_boss_spawner"),1f));
