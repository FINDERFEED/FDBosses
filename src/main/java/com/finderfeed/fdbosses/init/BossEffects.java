...
public class BossEffects {
    ...
    public static final RegistryObject<MobEffect> CHESED_GAZE = MOB_EFFECTS.register("chesed_gaze", ()->new SimpleEffect(MobEffectCategory.NEUTRAL,0x681cff));
    public static final RegistryObject<MobEffect> CHESED_DARKEN = MOB_EFFECTS.register("chesed_darken", ()->new SimpleEffect(MobEffectCategory.NEUTRAL,0x000000));
    public static final RegistryObject<MobEffect> CHESED_ENERGIZED = MOB_EFFECTS.register("chesed_energized", ()->new SimpleEffect(MobEffectCategory.NEUTRAL,0x00edd9));
