...
//
//    public static final NetworkCodec<FriendlyByteBuf, ItemCoreDataComponent> STREAM_CODEC = NetworkCodec.composite(
//            NetworkCodec.STRING_UTF8,v->v.getCoreType().name(),
