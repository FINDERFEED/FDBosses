...
public class RadialEarthquakeEntity extends Entity implements AutoSerializable {
    ...
    public void spawnAndDamageWithRadius(int rad){
        ...
        PacketDistributor.sendToPlayersNear((ServerLevel) this.level(), null, this.getX(), this.getY(), this.getZ(), Math.max(endRadius * 2,120), new SpawnRadialEarthquakeOnRadiusPacket(this,rad));
