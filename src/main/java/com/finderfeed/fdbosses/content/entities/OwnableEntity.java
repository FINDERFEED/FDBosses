...
public class OwnableEntity extends Entity {
    ...
    public static final EntityDataAccessor<Integer> OWNER = SynchedEntityData.defineId(OwnableEntity.class, EntityDataSerializers.INT);

    private UUID owner;

    public OwnableEntity(EntityType<?> type, Level level) {
        super(type, level);
    }
